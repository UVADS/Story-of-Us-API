 ...
 */
class TaxonomyEntityNormalizer extends ContentEntityNormalizer {
  /**
 ...
 */
  protected $supportedInterfaceOrClass = 'Drupal\taxonomy\Entity\Term';
    ...
    /**
   * Remap any field or property to any other name.
   *
   * @var array
   */
  protected $remap = [
  ...
  protected $valueKeys = [
    ...
    'field_request_info_link' => 'uri',
    'field_profile_url' => 'uri',
    'field_url' => 'uri',
   // 'field_video' => 'uri',
 ...
 * {@inheritdoc}
 ...
 public function getFields() {
  ...
  public function addFields() {
    $this->fields['path'] = '/taxonomy/term/' . $this->fields['id'];
    return $this;
  }
